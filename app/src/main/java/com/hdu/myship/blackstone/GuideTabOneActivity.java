...
public class GuideTabOneActivity extends AppCompatActivity {
    ...
    private int[] image2Id=new int[]{0,R.drawable.two2};
    ...
    public void init(){
        ...
        ItemBeam itemBeam = new ItemBeam(title[0], text[0],imageId[0], 0);
        list.add(itemBeam);
        ItemBeam itemBeam2 = new ItemBeam(title[1], text[1],imageId[1],image2Id[1], 1);
        list.add(itemBeam2);
    ...
    public class HeadAdapter extends BaseAdapter implements StickyListHeadersAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            ...
            ImageView im2= (ImageView) convertView.findViewById(R.id.im2);
            im2.setImageResource(list.get(position).getImage2id());
            im2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(GuideTabOneActivity.this,ShowImageActivity.class);
                    intent.putExtra("title",list.get(position).getImage2id());
                    startActivity(intent);
                }
            });
            return convertView;
    ...
    public class ItemBeam
    {
        ...
        private int id;
        public ItemBeam(String catalog,String content,int imageid,int id){
            this.catalog=catalog;
            this.content=content;
            this.imageid=imageid;
            this.id=id;
        }
        public ItemBeam(String catalog,String content,int imageid,int image2id,int id){
            this.catalog=catalog;
            this.content=content;
            this.imageid=imageid;
