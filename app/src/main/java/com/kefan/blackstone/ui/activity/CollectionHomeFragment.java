...
public class CollectionHomeFragment extends BaseFragment {
    ...
    @BindView(R.id.lv_category_home_collection_fragment)
    ListView listView;
...
//        setContentView(R.layout.fragment_home_collection);
//        initData();
//        initViews();
//        initEvents();
//    }
...
//                Toast.makeText(CollectionHomeFragment.this, "网络异常", Toast.LENGTH_SHORT).show();
//            }
//        }){
//            @Override
